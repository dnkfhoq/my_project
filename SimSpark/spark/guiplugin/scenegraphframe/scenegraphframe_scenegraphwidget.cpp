...
SceneGraphWidget::SceneGraphWidget(std::shared_ptr<SparkSimulationThread> thread, SceneGraphFrame* creator, QWidget* parentWidget) :
...
void SceneGraphWidget::updateDisplay(std::shared_ptr<SparkSimulationThread> thread)
{
    mSparkController = std::shared_ptr<SparkController>(thread->getSparkController());
...
{
    std::shared_ptr<zeitgeist::Leaf> leaf(getCurrentLeaf());
...
std::shared_ptr<zeitgeist::Leaf> SceneGraphWidget::getCurrentLeaf() const
{
...
void SceneGraphWidget::updateDisplay(std::shared_ptr<SparkController> controller)
{
...
void SceneGraphWidget::initModelView(std::shared_ptr<SparkController> controller)
{
    //Handle new spark object
    mSparkController = std::shared_ptr<SparkController>(controller);
...
bool SceneGraphWidget::canExpandItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return true;
}

bool SceneGraphWidget::canCollapseItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return true;
}

bool SceneGraphWidget::canPrintItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return true;
}

bool SceneGraphWidget::canDeleteItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return leaf.get();
}

bool SceneGraphWidget::canInspectItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return leaf.get();
}

bool SceneGraphWidget::canCutItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return leaf.get();
}

bool SceneGraphWidget::canPasteInItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return leaf.get();
}

bool SceneGraphWidget::canLoadInItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    if (leaf.get() == 0)
        return false;

    std::shared_ptr<oxygen::BaseNode> bn(std::dynamic_pointer_cast<oxygen::BaseNode>(leaf));
    if (bn.get() == 0)
    {
...
bool SceneGraphWidget::canSaveItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf) const
{
    return false;
}

void SceneGraphWidget::expandItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    ui.sceneGraphTreeView->expandChildren(index);
}

void SceneGraphWidget::collapseItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    ui.sceneGraphTreeView->collapseChildren(index, false);
}

void SceneGraphWidget::printItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    ...
    {
        std::shared_ptr<zeitgeist::Node> parent = leaf->GetParent().lock();
...
void SceneGraphWidget::deleteItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
...
void SceneGraphWidget::inspectItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
...
void SceneGraphWidget::cutItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
...
void SceneGraphWidget::pasteInItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
...
void SceneGraphWidget::loadInItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
    ...
    if (returning != 0)
    {
        ...
        std::shared_ptr<zeitgeist::ParameterList> list(new zeitgeist::ParameterList());

        mSparkController->queueCommand(new SparkCommand::ImportScene(file, bn, list), 100, this, SLOT(onImportScene(int, bool)));
    }
}

void SceneGraphWidget::saveItem(const QModelIndex& index, std::shared_ptr<zeitgeist::Leaf> leaf)
{
    if (leaf.get() == 0)
    {
        //Item was already deleted
