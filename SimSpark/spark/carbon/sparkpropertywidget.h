...
public:
    ...
    */
    PropertyWidget(QWidget* parent, std::shared_ptr<SparkController> sparkcontroller);

    /*!
     \brief Set the managed zeitgeist::Leaf.
    */
    void setLeaf(std::weak_ptr<zeitgeist::Leaf> leaf);
    /*!
...
protected:
    ...
    std::shared_ptr<SparkController> mSparkController; /*!< SparkController of the currently selected leaf. */
    std::weak_ptr<zeitgeist::Leaf> mLeaf;              /*!< The currently selected leaf. */
