...
private:
    ...
    */
    static std::shared_ptr<CarbonLogControl> getLogControl();
...
private:
    ...
    std::shared_ptr<Settings> mSettings; /*!< Global Settings object. May be stored in different places.*/
    ...
    //Logging
    static std::shared_ptr<Carbon::CarbonLogControl> mCarbonLogControlStatic; /*!< Log appender collection for carbon. Created if there is no static gui controller yet. */
    std::shared_ptr<Carbon::CarbonLogControl> mCarbonLogControl; /*!< Log appender collection for carbon. Created from the static log control and used afterwards. */
};
