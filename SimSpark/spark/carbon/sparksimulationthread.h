...
public:
    ...
    */
    std::shared_ptr<SparkController> getSparkController() const;
...
protected:
    ...
    */
    SparkSimulationThread(std::shared_ptr<TaskDefinition> definition);
...
protected:
    ...
    std::shared_ptr<SparkController> mController; /*!< Pointer to spark controller. */
