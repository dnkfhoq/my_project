...
public:
    ...
    */
    std::shared_ptr<PluginDefinition> getPluginDefinition() const;
    /*!
    ...
    */
    void setPluginDefinition(std::shared_ptr<PluginDefinition> definition);
    ...
    */
    virtual bool loadData(std::shared_ptr<QSettings> data);
    /*!
    ...
    */
    virtual bool saveData(std::shared_ptr<QSettings> data) const;
...
protected:
    ...
    std::shared_ptr<PluginDefinition> mPluginDefinition; /*!< Pointer to the definition that created the plugin in the current Simulation. */

private:
    //private members

    std::shared_ptr<Settings> mPrivateSettings; /*!< Private pointer to the global settings object. */
...
public:
    ...
    */
    std::shared_ptr<PluginInstantiatorTableModel> getTableModel();
