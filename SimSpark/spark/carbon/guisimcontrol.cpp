...
void GuiSimControl::registerSimControl(std::shared_ptr<ISimControl> simControl)
{
    bool found = false;
...
void GuiSimControl::unregisterSimControl(std::shared_ptr<ISimControl> simControl)
{
