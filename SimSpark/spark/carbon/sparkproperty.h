...
*/
typedef std::vector<std::shared_ptr<Property>> TProperties;
/*!
 \brief Helper type for zeitgeist leaf shared ptr.
*/
typedef std::shared_ptr<zeitgeist::Leaf> TLeafPtr;
/*!
 \brief Helper type for zeitgeist class shared ptr.
*/
typedef std::shared_ptr<zeitgeist::Class> TClassPtr;
...
public:
    ...
    */
    Property(std::shared_ptr<zeitgeist::Leaf> leaf, ClassDescriptor classDes, const QString& name, const QString& caption,
    ...
    */
    ...
    /*!
     ...
     \return true if set was successful, false if property access timed out, the value is currently read-updating or an error occurred
    */
    bool setValue(std::shared_ptr<Data> data);
    /*!
    ...
    */
    ...
    std::weak_ptr<zeitgeist::Leaf> getLeaf(); /*!< Returns leaf to interact with. */
...
protected:
    ...
    */
    void setValueProtected(std::shared_ptr<Data> data);
...
protected:
    ...
    std::weak_ptr<zeitgeist::Leaf> mLeaf; /*!< Leaf to interact with. */
    ...
    std::shared_ptr<Data> mValue;     /*!< Last read value of the property. */
    ...
    std::shared_ptr<Data> mTempValue; /*!< Temporary value while write-updating. */
