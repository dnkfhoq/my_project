...
std::shared_ptr<Data> Data::createData(EDataType type)
{
    switch(type)
    {
        case DT_INT   : return std::shared_ptr<Data>(new DInt(0)); break;
        case DT_LONG  : return std::shared_ptr<Data>(new DLong(0)); break;
        case DT_FLOAT : return std::shared_ptr<Data>(new DFloat(0.0)); break;
        case DT_DOUBLE: return std::shared_ptr<Data>(new DDouble(0.0)); break;
        case DT_BOOL  : return std::shared_ptr<Data>(new DBool(false)); break;
        case DT_STRING: return std::shared_ptr<Data>(new DString(QString(""))); break;
        case DT_VEC3F : return std::shared_ptr<Data>(new DVector3f(Vector3f())); break;
        case DT_RGBA  : return std::shared_ptr<Data>(new DRGBA(RGBA())); break;
        case DT_AABB3 : return std::shared_ptr<Data>(new DAABB3(AABB3())); break;
        case DT_MAT4X4: return std::shared_ptr<Data>(new DMat4x4(Matrix())); break;
        default:
...
std::shared_ptr<Data> Data::createData(EDataType type, const QString& dataString)
{
    std::shared_ptr<Data> dat = createData(type);
