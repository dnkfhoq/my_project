...
private:
    ...
    */
    std::shared_ptr<Topic> getSelf() const;
    ...
    */
    std::shared_ptr<TopicRegistration> findSender(const AbstractPlugin* sender, int& index) const;
    /*!
     \brief Return a topic registry entry for a sender plugin.
     ...
     \return pointer to registree or null pointer if nothing was found
    */
    std::shared_ptr<TopicRegistration> findSender(const AbstractPlugin* sender) const;
    /*!
     ...
     \return pointer to registree or null pointer if nothing was found
    */
    std::shared_ptr<TopicRegistration> findReceiver(const AbstractPlugin* receiver, int& index) const;
    /*!
     \brief Return a topic registry entry for a receiver plugin.
     ...
     \return pointer to registree or null pointer if nothing was found
    */
    std::shared_ptr<TopicRegistration> findReceiver(const AbstractPlugin* receiver) const;
...
public: signals:
    ...
    */
    void connected(const AbstractPlugin* sender, const AbstractPlugin* receiver, std::shared_ptr<Topic> topic);
    /*!
     ...
     \param topic pointer to this Topic
    */
    void disconnected(const AbstractPlugin* sender, const AbstractPlugin* receiver, std::shared_ptr<Topic> topic);
...
private:
    ...
    QList<std::shared_ptr<TopicRegistration>> mSenders; /*!< List of senders. */
    QList<std::shared_ptr<TopicRegistration>> mReceivers; /*!< List of receivers. */
