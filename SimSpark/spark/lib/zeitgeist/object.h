 ...
 *  class object. Every object holds a std::shared_ptr to the class object,
 *  which created it.
*/
...
public:
     ...
     */
    bool Construct(const std::shared_ptr<Object>& self, const std::shared_ptr<Class>& creator);
