...
private:
    ...
    std::shared_ptr<ScriptServer> GetScriptServer()
    {       return GetScript();     }
...
private:
    /** true if Start() has been called after linking for the first time */
    bool mInitialStartComplete;
};
