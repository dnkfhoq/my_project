...
public:
    ...
    */
    ...
    static std::shared_ptr<RigidBody> GetBody(long id);
    ...
    */
    std::unique_ptr<GenericMass, GenericMassDeleter> CreateMass(float mass, salt::Vector3f cVector);
...
private:
    ...
    */
    ...
    //
protected:
    static std::shared_ptr<RigidBodyInt> mRigidBodyImp;
};
