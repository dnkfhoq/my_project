...
std::shared_ptr<SliderJointInt> SliderJoint::mSliderJointImp;
...
void SliderJoint::OnLink()
{
    if (mSliderJointImp.get() == 0)
        mSliderJointImp = std::dynamic_pointer_cast<SliderJointInt>
...
void SliderJoint::Attach(std::shared_ptr<RigidBody> body1, std::shared_ptr<RigidBody> body2)
{
