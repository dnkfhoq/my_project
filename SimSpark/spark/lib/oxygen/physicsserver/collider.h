...
public:
    ...
    /** notifies the Collider that a collision with another geometry
       ...
       symmetric case
    */
    virtual void OnCollision (std::shared_ptr<Collider> collidee,
    ...
    static std::shared_ptr<Collider> GetCollider(long geomID);
    ...
    */
     ...
     */
    bool Intersects(std::shared_ptr<Collider> collider);
    ...
    bool InNotCollideWithSet( std::shared_ptr<Collider>  col2 );
...
private:
    static std::shared_ptr<ColliderInt> mColliderImp;
