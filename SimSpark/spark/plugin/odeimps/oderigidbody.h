...
public:
    ...
    std::unique_ptr<oxygen::GenericMass, oxygen::GenericMassDeleter> CreateMass(float mass, salt::Vector3f cVector);
...
private:
    class dMassDeleter : public oxygen::GenericMassDeleter
    {
    public:
        virtual void operator()(oxygen::GenericMass* mass);
    };
};
