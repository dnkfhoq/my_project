...
protected:
    ...
    void AddAgents(std::shared_ptr<oxygen::Scene> activeScene, std::ostringstream& ss) const;

    /** collects flag data and constructs a S-Expression description */
    void AddFlags(std::shared_ptr<oxygen::Scene> activeScene, std::ostringstream& ss);

    /** adds ball data to output string stream */
    void AddBall(std::shared_ptr<oxygen::Scene> activeScene, std::ostringstream& ss) const;
...
protected:
    ...
    std::shared_ptr<TrainerCommandParser> mCommandParser;

    std::shared_ptr<BallStateAspect> mBallState;
