...
{
    std::shared_ptr<ScriptServer> scriptServer = GetCore()->GetScriptServer();
    ...
    mGameState = std::dynamic_pointer_cast<GameStateAspect>
    ...
    mSoccerRule = std::dynamic_pointer_cast<SoccerRuleAspect>
    ...
    // get camera body
    mCameraBody = std::dynamic_pointer_cast<RigidBody>
    ...
    // get fps controller
    mFPS = std::dynamic_pointer_cast<FPSController>
            ...
            if (input.GetKeyPress())
            {
                        ...
                        )
                    {
                        ...
                        std::shared_ptr<AgentState> agentState =
                            std::dynamic_pointer_cast<AgentState>((*iter)->GetChild("AgentState", true));
