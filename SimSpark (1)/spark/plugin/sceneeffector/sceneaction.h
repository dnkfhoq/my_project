...
public:
    SceneAction(const std::string& predicate, const std::string& scene,
        std::shared_ptr<zeitgeist::ParameterList> parameters)
    ...
    const std::shared_ptr<zeitgeist::ParameterList> &GetSceneParameters()
            { return mParameters; }
...
protected:
    ...
    std::shared_ptr<zeitgeist::ParameterList> mParameters;
};
