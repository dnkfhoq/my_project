...
void KeyboardSDL::SetupSymMap()
{
    ...
    // later adjusted to match <SDL2/SDL_keycode.h>
    ...
    // [...]
    // SDLK_WORLD_95
    mSymbols[SDLK_KP_0]         = Input::IC_KP0;
    mSymbols[SDLK_KP_1]         = Input::IC_KP1;
    mSymbols[SDLK_KP_2]         = Input::IC_KP2;
    mSymbols[SDLK_KP_3]         = Input::IC_KP3;
    mSymbols[SDLK_KP_4]         = Input::IC_KP4;
    mSymbols[SDLK_KP_5]         = Input::IC_KP5;
    mSymbols[SDLK_KP_6]         = Input::IC_KP6;
    mSymbols[SDLK_KP_7]         = Input::IC_KP7;
    mSymbols[SDLK_KP_8]         = Input::IC_KP8;
    mSymbols[SDLK_KP_9]         = Input::IC_KP9;
    ...
    // SDLK_F14
    // SDLK_F15
    mSymbols[SDLK_NUMLOCKCLEAR] = Input::IC_NUMLOCK;
    mSymbols[SDLK_CAPSLOCK]     = Input::IC_CAPSLOCK;
    mSymbols[SDLK_SCROLLLOCK]   = Input::IC_SCROLLOCK;
    ...
    // SDLK_RMETA
    // SDLK_LMETA
    mSymbols[SDLK_LGUI]         = Input::IC_LSUPER;
    mSymbols[SDLK_RGUI]         = Input::IC_RSUPER;
    // SDLK_MODE
    // SDLK_COMPOSE
    // SDLK_HELP
    mSymbols[SDLK_PRINTSCREEN]  = Input::IC_PRINT;
    // SDLK_SYSREQ
    // SDLK_BREAK
    // SDLK_MENU
    // SDLK_POWER
