...
#include <SDL.h>
#endif
#include <salt/function_deleter.h>
...
private:
    salt::unique_ptr_d<SDL_Window, SDL_DestroyWindow> mWindow;
    salt::unique_ptr_d<std::remove_pointer_t<SDL_GLContext>, SDL_GL_DeleteContext> mGlContext;
    bool mWantsToQuit;
};
