...
*/
#ifndef OXYGEN_STDTIMERSYSTEM_H
#define OXYGEN_STDTIMERSYSTEM_H
...
namespace oxygen
{
/** \class TimerSystemStd is a timer system based on the standard library
 *  timing facilities
 */
class TimerSystemStd: public TimerSystem
{
public:
...
private:
    ...
    std::chrono::time_point<std::chrono::steady_clock> mLastQueryTime;
};

DECLARE_CLASS(TimerSystemStd)

} // namespace oxygen

#endif // OXYGEN_STDTIMERSYSTEM_H
