...
{
public:
    typedef std::set<std::shared_ptr<Collider> > TCollisionSet;
    typedef std::list<std::weak_ptr<Node> > TParentList;
...
public:
    ...
    */
    ...
    void FindParentsSupportingClass(TParentList &list)
    {
        ...
        {
            std::shared_ptr<oxygen::Collider> collidee = *iter;

            std::weak_ptr<zeitgeist::Node> parent =
