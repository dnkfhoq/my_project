...
SpadesServer::OnLink()
{
    mMonitorServer = std::dynamic_pointer_cast<MonitorServer>
    ...
    mGameControlServer = std::dynamic_pointer_cast<GameControlServer>
...
std::shared_ptr<GameControlServer>
...
{
    mParamReader =
        std::static_pointer_cast<ParamReader>(GetCore()->New("oxygen/ParamReader"));
