...
public:
    ...
    std::shared_ptr<GameControlServer> GetGameControlServer() const;
...
private:
    ...
    std::shared_ptr<ParamReader> mParamReader;
    ...
    */
    ...
    std::shared_ptr<MonitorServer> mMonitorServer;

    /** a cached reference to the GameControlServer */
    std::shared_ptr<GameControlServer> mGameControlServer;

    /** a cached reference to the SceneServer */
    std::shared_ptr<SceneServer> mSceneServer;
