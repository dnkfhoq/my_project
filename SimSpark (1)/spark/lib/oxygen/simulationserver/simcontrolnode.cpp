...
std::shared_ptr<SimulationServer> SimControlNode::GetSimulationServer()
{
    return std::static_pointer_cast<SimulationServer>
        (GetParent().lock());
}
...
std::shared_ptr<Scene> SimControlNode::GetActiveScene()
{
