...
MonitorServer::RegisterMonitorSystem(const std::string& monitorSysName)
{
    ...
    std::shared_ptr<MonitorSystem> monitorSys =
        std::dynamic_pointer_cast<MonitorSystem>(GetChildOfClass(monitorSysName));
    ...
    monitorSys = std::dynamic_pointer_cast<MonitorSystem>(GetCore()->New(monitorSysName));
...
MonitorServer::RegisterMonitorItem(const std::string& monitorItemName)
{
    ...
    std::shared_ptr<MonitorItem> monitorItem =
        std::dynamic_pointer_cast<MonitorItem>(GetChildOfClass(monitorItemName));
    ...
    monitorItem = std::dynamic_pointer_cast<MonitorItem>(GetCore()->New(monitorItemName));
...
std::shared_ptr<MonitorSystem> MonitorServer::GetMonitorSystem()
{
    return std::static_pointer_cast<MonitorSystem>
        (
...
MonitorServer::CollectItemPredicates(bool initial, PredicateList& pList)
{
    ...
    {
        std::shared_ptr<MonitorItem> item =
            std::static_pointer_cast<MonitorItem>(*iter);
...
{
    std::shared_ptr<MonitorSystem> monitorSystem = GetMonitorSystem();
    ...
    PredicateList pList;
    std::lock_guard dataLock(mMonitorMutex);
