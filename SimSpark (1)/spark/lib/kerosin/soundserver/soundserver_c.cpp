...
FUNCTION(SoundServer,playStream)
{
    ...
    std::shared_ptr<SoundStream> stream = obj->LoadStream(inName);
...
FUNCTION(SoundServer,playModule)
{
    ...
    std::shared_ptr<SoundModule> module = obj->LoadModule(inName);
...
FUNCTION(SoundServer,playEffect)
{
    ...
    std::shared_ptr<SoundEffect> effect = obj->LoadEffect(inName);
