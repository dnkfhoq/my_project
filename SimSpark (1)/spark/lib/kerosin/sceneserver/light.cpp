...
void Light::RenderLitMesh(std::shared_ptr<StaticMesh> /*mesh*/)
{
    /*
...
void Light::DeterminePotentiallyLitTriangles(std::shared_ptr<StaticMesh>& /*mesh*/, std::vector<unsigned int>& /*triangles*/)
{
    /*
