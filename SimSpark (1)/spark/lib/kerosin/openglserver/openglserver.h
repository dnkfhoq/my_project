...
public:
    ...
    /** Initializes the OpenGLServer and creates the OpenGLSystem with
    ...
    */
    ...
    /** Initializes the OpenGLSystem, which should be called in the main
     *  rendering thread
     */
    bool InitOpenGLSystem();
...
protected:
    ...
    std::shared_ptr< MapHolder > mHolder;
    ...
    std::shared_ptr<OpenGLSystem> mGLSystem;
};
