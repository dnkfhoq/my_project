...
std::shared_ptr<FPSController> InputControl::GetFPSController()
{
            ...
            switch (input.mId)
                ...
                default:
                    ...
                    for (
                        ...
                        {
                            std::static_pointer_cast<InputItem>(*iter)
                                ->ProcessInput(input);
                        }
                    break;
                }
...
InputControl::RegisterInputItem(const string& inputItemName, const string& name)
{
    ...
    std::shared_ptr<InputItem> inputItem =
        std::dynamic_pointer_cast<InputItem>(GetChildOfClass(inputItemName));
    ...
    inputItem = std::dynamic_pointer_cast<InputItem>(GetCore()->New(inputItemName));
