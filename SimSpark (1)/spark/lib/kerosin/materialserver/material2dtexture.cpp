...
bool Material2DTexture::LoadTexture(const std::string& texName, std::shared_ptr<Texture>& store)
{
    std::shared_ptr<ScriptServer> scriptServer = GetCore()->GetScriptServer();
    std::shared_ptr<TextureServer> textureServer = std::dynamic_pointer_cast<TextureServer>
