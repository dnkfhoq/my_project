...
public:
    ...
    */
    PropertyControl(PropertyManager* parent, const QString& name, std::shared_ptr<PropertyExecuter> executer);
    /*!
     \brief Constructor.
    ...
    */
    void createExecuter(std::shared_ptr<SparkController> controller);
    /*!
...
protected:
    ...
    */
    virtual bool updateProperty(std::shared_ptr<Property> prop) = 0;
    /*!
     \brief Apply data stored in the property.

     \param prop property to apply temporary data from
    */
    virtual bool applyPropertyChange(std::shared_ptr<Property> prop) = 0;
...
protected slots:
    ...
    */
    void acceptChange(std::shared_ptr<SparkProperty::Property> prop);
    /*!
     \brief Reject the temporary data in the property.

     Update result will be forwarded to the property.
    */
    void rejectChange(std::shared_ptr<SparkProperty::Property> prop);
    /*!
    ...
    */
    void updated(std::shared_ptr<SparkProperty::Property> prop, bool success);
...
protected:
    ...
    std::shared_ptr<PropertyExecuter> mExecuter; /*!< Executer which calls the read and write update functions. */
    std::shared_ptr<SparkController> mSparkController; /*!< SparkController to interact with. */
};
