...
SimulationTask* SimulationTask::createSimulationTask(std::shared_ptr<TaskDefinition> definition)
{
...
SimulationTask::SimulationTask(std::shared_ptr<TaskDefinition> definition) :
