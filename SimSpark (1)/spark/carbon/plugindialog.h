...
private:
    ...
    std::shared_ptr<PluginTableModel> mModel; /*!< Model of the plugin managers plugin list. */
    std::shared_ptr<PluginInstantiatorTableModel> mInstantiatorModel; /*!< Model of the plugin factories instantiator list. */
