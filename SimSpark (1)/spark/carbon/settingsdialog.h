...
public:
    ...
    */
    struct PageDefinition
    {
        ...
        */
        PageDefinition(QString pageName, SettingsWidget** widget, AbstractPlugin* creator, std::weak_ptr<TopicDefinition> topic)
            : mTopic(topic)
        {
            mWidget = widget;
            if (creator != 0)
        ...
        */
        ...
        std::weak_ptr<TopicDefinition> mTopic;  /*!< Pointer to parent topic. */
    ...
    */
    typedef std::vector<std::shared_ptr<PageDefinition>> TPageList;
    ...
    */
    typedef std::vector<std::shared_ptr<TopicDefinition>> TTopicList;
...
public:
    ...
    */
    std::shared_ptr<PageDefinition> getCurrentPage();
    /*!
     \brief Returns current TopicDefinition or null pointer if there is none.
    */
    std::shared_ptr<TopicDefinition> getCurrentTopic();
...
protected:
    ...
    */
    std::shared_ptr<TopicDefinition> getTopicDefinition(const QString& topicname);
    /*!
    ...
    */
    std::shared_ptr<PageDefinition> getPageDefinition(const QString& topicname, const QString& pagename);
    /*!
     \brief Return page definition pointer by name.
    ...
    */
    std::shared_ptr<PageDefinition> getPageDefinition(const TopicDefinition& topic, const QString& pagename);
    ...
    */
    std::shared_ptr<TopicDefinition> createTopic(const QString& topicname, const QString& iconpath = QString(""));
    /*!
     ...
     \return pointer to the added topic with name topicname
    */
    std::shared_ptr<PageDefinition> createPage(const QString& topicname, const QString& pagename);
