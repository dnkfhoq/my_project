...
AbstractPlugin::AbstractPlugin(EPluginType type) :
    mPluginDefinition(std::shared_ptr<PluginDefinition>())
{
    mPluginType = type;
...
bool AbstractPlugin::loadData([[maybe_unused]] std::shared_ptr<QSettings> data)
{
    return false;
}

bool AbstractPlugin::saveData([[maybe_unused]] std::shared_ptr<QSettings> data) const
{
    return false;
}
...
void AbstractPlugin::setPluginDefinition(std::shared_ptr<PluginDefinition> definition)
{
    mPluginDefinition = definition;
    mPluginDefinition->setId(getPluginId());
}

std::shared_ptr<PluginDefinition> AbstractPlugin::getPluginDefinition() const
{
...
std::shared_ptr<PluginInstantiatorTableModel> PluginFactory::getTableModel()
{
    return std::shared_ptr<PluginInstantiatorTableModel>(new PluginInstantiatorTableModel(mInstantiatorMap));
}
