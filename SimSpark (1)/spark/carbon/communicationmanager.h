...
public:
    ...
    */
    std::shared_ptr<Topic> getTopic(const QString& name);
...
protected:
    ...
    */
    QList<std::shared_ptr<Topic>>::Iterator removeTopic(Topic* topic);
...
private:
    ...
    QList<std::shared_ptr<Topic>> mTopics;  /*!< List of topics. */
};
