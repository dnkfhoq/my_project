...
public:
    ...
    */
    void queueMessageObject(const std::shared_ptr<LogMessage>& object);
...
private: signals:
    ...
    */
    void queuedMessageObject(std::shared_ptr<LogMessage> object);
...
private slots:
    ...
    */
    void receiveMessageObject(std::shared_ptr<LogMessage> object);
...
/*!
 ...
 Message Objects will always be given as std::shared_pointer, so no unneccesary copies are created and they delete automatically if
...
public:
    ...
    */
    virtual void receiveMessageObject(std::shared_ptr<LogMessage> object);
    ...
    */
    ...
    /*!
     ...
     \param object message content and meta information as LogMessage
    */
    void receiveMessageObjectQueued(const std::shared_ptr<LogMessage>& object);
...
protected:
    ...
    */
    ...
    /*!
     ...
     \return formatted string
    */
    QString formatMessage(std::shared_ptr<LogMessage> message);
