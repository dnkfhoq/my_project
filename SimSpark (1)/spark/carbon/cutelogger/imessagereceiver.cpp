...
ThreadMessageQueue::ThreadMessageQueue(IMessageReceiver* receiveTarget)
{
    ...
    connect(this, SIGNAL(queuedMessageObject(std::shared_ptr<LogMessage>)), this, SLOT(receiveMessageObject(std::shared_ptr<LogMessage>)));
}
...
void ThreadMessageQueue::receiveMessageObject(std::shared_ptr<LogMessage> object)
{
...
void ThreadMessageQueue::queueMessageObject(const std::shared_ptr<LogMessage>& object)
{
...
void IMessageReceiver::receiveMessageObject(std::shared_ptr<LogMessage> newMessage)
{
...
void IMessageReceiver::receiveMessageObjectQueued(const std::shared_ptr<LogMessage>& object)
{
    if (!mQueueInterThreadMessages)
...
QString IMessageReceiver::formatMessage(std::shared_ptr<LogMessage> message)
{
