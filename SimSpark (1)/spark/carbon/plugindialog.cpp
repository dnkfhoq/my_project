    ...
    ui(new Ui::PluginDialog)
{
    ...
    mModel = std::shared_ptr<PluginTableModel>(Carbon::get()->getPluginManager()->getTableModel());
    ...
    mInstantiatorModel = std::shared_ptr<PluginInstantiatorTableModel>(PluginFactory::getFactory().getTableModel());
