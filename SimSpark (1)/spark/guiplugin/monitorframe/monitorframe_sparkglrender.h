    ...
    */
    struct RenderSelectionContext
    {
        /*!
         ...
         \param node
        */
        RenderSelectionContext(std::shared_ptr<oxygen::BaseNode> node);
        /*!
         \brief Destructor.
...
public:
    ...
    */
    bool init(std::shared_ptr<SimSpark> spark);
    /*!
    ...
    */
    std::weak_ptr<kerosin::RenderNode> pickNode(int x, int y, int width, int height);
...
protected:
    ...
    std::shared_ptr<SimSpark> mSpark; /*!< Pointer to SimSpark. */
    std::shared_ptr<oxygen::Camera> mCamera; /*!< Pointer to Camera. */
    std::shared_ptr<oxygen::SceneServer> mSceneServer; /*!< Pointer to scene server. */
    std::shared_ptr<kerosin::RenderServer> mRenderServer; /*!< Pointer to render server. */
    std::shared_ptr<kerosin::RenderControl> mRenderControl; /*!< Pointer to render control. */
