...
void Run()
{    
    //std::unique_ptr<Behavior> behavior(new SoccerbotBehavior());
    //std::unique_ptr<Behavior> behavior(new SoccerBehavior());
    //std::unique_ptr<Behavior> behavior(new CarBehavior());
    //std::unique_ptr<Behavior> behavior(new LeggedSphereBehavior());
    //std::unique_ptr<Behavior> behavior(new Hoap2Behavior());
    std::unique_ptr<Behavior> behavior(new NaoBehavior());
