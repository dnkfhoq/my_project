...
GameStateAspect::GameStateAspect() : SoccerControlAspect()
{
    ...
    mPenaltyShootoutShotsExecuted = 0;
}
...
bool
GameStateAspect::RequestUniform(std::shared_ptr<AgentState> agentState,
...
int GameStateAspect::GetPenaltyShootoutShotsExecuted()
{
    return mPenaltyShootoutShotsExecuted;
}

void GameStateAspect::PenaltyShootoutShotExecuted()
{
    mPenaltyShootoutShotsExecuted++;
}
