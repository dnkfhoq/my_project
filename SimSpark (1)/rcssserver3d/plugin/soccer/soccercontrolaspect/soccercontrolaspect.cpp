...
std::shared_ptr<RecorderHandler> SoccerControlAspect::GetBallRecorder()
{
    string ballRecorder;
    SoccerBase::GetSoccerVar(*this,"BallRecorder",ballRecorder);
    std::shared_ptr<RecorderHandler> node = std::dynamic_pointer_cast<RecorderHandler>
...
std::shared_ptr<RecorderHandler> SoccerControlAspect::GetLeftGoalRecorder()
{
    string goalRecorder;
...
std::shared_ptr<RecorderHandler> SoccerControlAspect::GetRightGoalRecorder()
{
    string goalRecorder;
