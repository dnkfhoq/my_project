...
{
    mRay = std::static_pointer_cast<oxygen::RayCollider>
...
bool
VisionPerceptor::StaticAxisPercept(std::shared_ptr<PredicateList> predList)
{
...
bool
VisionPerceptor::DynamicAxisPercept(std::shared_ptr<PredicateList> predList)
{
    Predicate& predicate = predList->AddPredicate();
    predicate.name       = mPredicateName;
    predicate.parameter.Clear();
...
bool
VisionPerceptor::Percept(std::shared_ptr<PredicateList> predList)
{
    if (
