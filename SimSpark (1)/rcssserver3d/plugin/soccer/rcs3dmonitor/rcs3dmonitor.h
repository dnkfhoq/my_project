...
public:
    ...
    typedef std::map<std::shared_ptr<oxygen::BaseNode>, NodeCache> TNodeCacheMap;
...
protected:
    ...
    */
    NodeCache* LookupNode(std::shared_ptr<oxygen::BaseNode> node);
    ...
    void DescribeScene(std::stringstream& ss,
                       std::shared_ptr<oxygen::BaseNode> node);
    ...
    */
    ...
    void DescribeTransform(std::stringstream& ss, NodeCache& entry,
                           std::shared_ptr<oxygen::Transform> transform, bool prefix = true);
    void DescribeMesh(std::stringstream& ss,
                      std::shared_ptr<kerosin::StaticMesh> mesh);
    void DescribeLight(std::stringstream& ss,
                       std::shared_ptr<kerosin::Light> light);
