...
void SoccerInput::OnLink()
{
    ...
    mMonitorClient = std::dynamic_pointer_cast<NetClient>
...
void SoccerInput::SelectCamera(int idx)
{
    ...
    std::shared_ptr<SoccerMonitor> soccerMonitor =
        std::static_pointer_cast<SoccerMonitor>(soccerMonitorList.front());
