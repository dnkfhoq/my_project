...
addSoccerVar('FreeKickMoveDist', 2.5)
...
addSoccerVar('PenaltyShootoutBallDistance', 6.0)
addSoccerVar('PenaltyShootoutBehindBallDistance', 4.0)
addSoccerVar('PenaltyShootoutMaxTime', 25.0)
addSoccerVar('PenaltyShootoutMinRounds', 5)
addSoccerVar('PenaltyShootoutMaxRounds', 10)
...
addSoccerVar('TouchingFoulBeamPenalty', false)

# ball holding foul parameters
addSoccerVar('BallHoldRadius', 0.12)
addSoccerVar('BallHoldMaxTime', 5.0)
addSoccerVar('BallHoldGoalieMaxTime', 10.0)
addSoccerVar('BallHoldResetTime', 0.5)
addSoccerVar('BallHoldMaxDistance', 1.0)
addSoccerVar('BallHoldOppDistance', -1)
addSoccerVar('BallHoldBeamPenalty', false)
...
addSoccerVar('IllegalDefenseBeamPenalty', false)
...
# Kick pass parameters
addSoccerVar('KickPassMaxPropulsionDistance', 5.0)
addSoccerVar('KickPassMinPropulsionDistance', 3.0)
addSoccerVar('KickPassMaxPropulsionSteps', 5)

# Catch parameters
addSoccerVar('CatchTime', 6.0)
addSoccerVar('CatchCooldownTime', 3.0)
